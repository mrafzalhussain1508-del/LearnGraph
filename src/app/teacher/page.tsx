      ...
      <div className="flex-1 min-w-0 p-4 sm:p-6 md:p-8 lg:p-10 max-w-7xl mx-auto space-y-6 sm:space-y-8 md:space-y-10 pb-24 md:pb-12 w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <Link
              href="/student"
              className="inline-flex items-center space-x-2 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 text-xs font-semibold px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs transition-colors"
            >
              <BookOpen className="w-4 h-4 text-rose-600" />
              <span>Preview Student Study Guide</span>
            </Link>
            <Link
              href="/upload"
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between pt-1 gap-2 border-t border-slate-100 dark:border-slate-800">
                          <button
                            ...
                            className="flex-1 py-2 rounded-xl bg-indigo-50 dark:bg-indigo-950/60 hover:bg-indigo-100 dark:hover:bg-indigo-900 text-indigo-700 dark:text-indigo-300 font-bold text-xs border border-indigo-200/60 dark:border-indigo-800/40 transition-colors cursor-pointer text-center"
                          >
                            View Full Profile
                          </button>
                          <Link
                            href="/student"
                            className="flex-1 py-2 rounded-xl bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 dark:hover:bg-slate-700 text-white font-bold text-xs transition-colors flex items-center justify-center space-x-1"
                          >
                            <span>Open Desk</span>
                        ...
                        >
                          ...
                          <td className="py-3.5 px-3.5 text-right whitespace-nowrap">
                            <div className="inline-flex items-center space-x-2">
                              ...
                              <Link
                                href="/student"
                                className="inline-flex items-center space-x-1 text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 font-bold text-xs transition-colors"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between pt-1 text-xs">
                        ...
                        <Link
                          href="/student"
                          className="inline-flex items-center space-x-1 text-indigo-600 dark:text-indigo-400 font-bold text-xs"
                        >
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3.5 px-3 text-right">
                          <Link
                            href="/student"
                            className="inline-flex items-center space-x-1 text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-bold text-xs"
                          >
                            <span>Study Guide</span>
                            <ArrowRight className="w-3 h-3" />
                          </Link>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 max-w-lg w-full max-h-[90vh] overflow-y-auto p-4 sm:p-6 md:p-7 shadow-2xl space-y-5 sm:space-y-6 relative">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-end gap-2 sm:space-x-3">
              ...
              >
                ...
                <span>Open Student Study Guide</span>
              </Link>
            </div>
          </div>
        </div>
